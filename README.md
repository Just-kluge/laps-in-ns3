...
4. sudo docker start laps-container

5. python3 /file-in-ctr/executableFiles/C00001/run.py

6. ./waf build

7. sudo docker cp /home/super/xiaojinyu/copy-p2p/model/. laps-container:/app/ns3-detnet-rdma-main/ns-3.33/src/point-to-point/model/
